...
class BaseDialog(QDialog, Ui_BaseDialog):
    def __init__(self, iface):
        ...
        self.mQgsProjection_PUNTO.setOptionVisible(
            self.mQgsProjection_PUNTO.CrsNotSet, True
        )
        ...
        if msg.exec_() == QMessageBox.Ok:
            ...
            try:
                ...
                filename = QtWidgets.QFileDialog.getSaveFileName(
                    self, "Escribe un nombre para la carpeta del proyecto:", "", ""
                )
    ...
    def MapaBase(self):
        ...
        layer = QgsVectorLayer(
            "C:/EasyBasin/Rasters/SIG/CH_SPAIN_WGS84.shp",
            "Límites de aplicación EasyBasin",
            "ogr",
        )
        QgsProject.instance().addMapLayer(layer)

        # Activar capa a editar
        spain = QgsProject.instance().mapLayersByName(
            "Límites de aplicación EasyBasin"
        )[0]
    ...
    def aforo(self):
        ...
        try:
            ...
            pointPath = (
                self.folder + "/EasyBasin/Capas_SIG/Punto_Salida/punto_salida.shp"
            )
            ...
            QMessageBox.critical(
                None,
                "ERROR",
                "Fallo al generar el Punto de Salida, revisa la información insertada.",
            )
    ...
    def raster(self):
        ...
        if not crs_MDT == QgsCoordinateReferenceSystem("EPSG:25830"):
            ...
            self.inputRaster.setFilePath(
                self.folder + "/EasyBasin/Capas_SIG/MDT/MDT_ETRS89.tif"
            )
        ...
        params = {
            ...
            "V_ANGLE": 40,
            "OUTPUT": self.folder
            + "/EasyBasin/Capas_SIG/Procesos_Internos/Hillshade.tif",
        }
        ...
        rlayer.setCrs(
            QgsCoordinateReferenceSystem(25830, QgsCoordinateReferenceSystem.EpsgCrsId)
        )
    ...
    def umbralCeldas(self):
        ...
        try:
            ...
            celdas = round(
                (float(umbral) * 10**6) / (float(pixelSizeX) * float(pixelSizeY))
            )
        except:
            celdas = 0
    ...
    def stream(self):
        ...
        if not os.path.exists(
            self.folder + "/EasyBasin/Capas_SIG/MDT/MDT_corregido.tif"
        ):

            # Proceso para corregir el MDT
            params = {
                "input": self.folder + "/EasyBasin/Capas_SIG/MDT/MDT.tif",
                "format": 0,
                "-f": False,
    ...
    def stream2(self):
        ...
        params2 = {
            ...
            "b": False,
            "accumulation": "None",
            "drainage": self.folder
            + "/EasyBasin/Capas_SIG/Procesos_Internos/drainage_direction.tif",
            "basin": self.folder
        ...
        # Añadir capa vectorial
        layer_streams = QgsVectorLayer(
            self.folder + "/EasyBasin/Capas_SIG/Red_Drenaje/Red_drenaje.shp",
            "Red de Drenaje",
            "ogr",
        )
        ...
        params4 = {
            "INPUT": self.folder + "/EasyBasin/Capas_SIG/Punto_Salida/punto_salida.shp",
            "REFERENCE_LAYER": self.folder
            + "/EasyBasin/Capas_SIG/Red_Drenaje/Red_drenaje.shp",
            "TOLERANCE": 1000,
            "BEHAVIOR": 3,
            "OUTPUT": self.folder
            + "/EasyBasin/Capas_SIG/Punto_Salida/punto_salida_corregido.shp",
        }
        processing.runAndLoadResults("native:snapgeometries", params4)

        # Cambiar nombre de la capa punto
        snappedPoint = QgsProject.instance().mapLayersByName("punto_salida_corregido")[
            0
        ]
    ...
    def basin(self):
        ...
        # Añadir capa vectorial y definir sistema coordenadas
        layer_stream = QgsVectorLayer(
            self.folder + "/EasyBasin/Capas_SIG/Red_Drenaje/Red_drenaje_cuenca.shp",
        ...
        params1 = {
            ...
            "STATISTICS": [5, 6],
            "OUTPUT": self.folder
            + "/EasyBasin/Capas_SIG/Procesos_Internos/basin_atr1.shp",
        }
        ...
        params2 = {
            ...
            "STATISTICS": [9],
            "OUTPUT": self.folder
            + "/EasyBasin/Capas_SIG/Procesos_Internos/basin_atr2.shp",
        }
        ...
        params3 = {
            ...
            "STATISTICS": [9],
            "OUTPUT": self.folder
            + "/EasyBasin/Capas_SIG/Procesos_Internos/basin_atr3.shp",
        }
        ...
        params4 = {
            ...
            "STATISTICS": [1],
            "OUTPUT": self.folder
            + "/EasyBasin/Capas_SIG/Procesos_Internos/basin_atr4.shp",
        }
        ...
        params5 = {
            ...
            "STATISTICS": [2],
            "OUTPUT": self.folder
            + "/EasyBasin/Capas_SIG/Procesos_Internos/basin_atr5.shp",
        }
        ...
        params6 = {
            ...
            "STATISTICS": [2],
            "OUTPUT": self.folder
            + "/EasyBasin/Capas_SIG/Procesos_Internos/basin_atr6.shp",
        }
        ...
        # Cambiar nombre de la capa punto
        snappedPoint = QgsProject.instance().mapLayersByName("cuenca_hidrografica_atr")[
            0
        ]
        ...
        if os.path.exists(
            self.folder + "/EasyBasin/Capas_SIG/Procesos_Internos/subcuencas.tif"
        ):
            ...
            params7 = {
                ...
                "DATA_TYPE": 0,
                "OUTPUT": self.folder
                + "/EasyBasin/Capas_SIG/Procesos_Internos/subcuencas_recortado.tif",
            }
            ...
            # Añadir capa vectorial
            layer_subbasins = QgsVectorLayer(
                self.folder + "/EasyBasin/HMS/Subcuencas/subcuencas.shp",
                "Subcuencas",
                "ogr",
            )
            ...
            if caps & QgsVectorDataProvider.AddAttributes:
                ...
                layer.dataProvider().addAttributes(
                    [QgsField("PERIMETRO", QVariant.Int)]
                )
            layer.updateFields()
            ...
            params = {
                ...
                "OUTPUT": self.folder
                + "/EasyBasin/Capas_SIG/Procesos_Internos/subcuencas_fix.shp",
            }
            processing.run("native:fixgeometries", params)
            ...
            params1 = {
                "INPUT": self.folder
                + "/EasyBasin/Capas_SIG/Procesos_Internos/subcuencas_fix.shp",
                "INPUT_RASTER": self.folder
                + "/EasyBasin/Capas_SIG/MDT/MDT_corregido.tif",
                "RASTER_BAND": 1,
                "COLUMN_PREFIX": "ALT_",
                "STATISTICS": [5, 6],
                "OUTPUT": self.folder
                + "/EasyBasin/Capas_SIG/Procesos_Internos/subbasin_atr1.shp",
            }
            processing.run("native:zonalstatisticsfb", params1)
            ...
            params2 = {
                ...
                "STATISTICS": [9],
                "OUTPUT": self.folder
                + "/EasyBasin/Capas_SIG/Procesos_Internos/subbasin_atr2.shp",
            }
            processing.run("native:zonalstatisticsfb", params2)
            ...
            params3 = {
                ...
                "STATISTICS": [9],
                "OUTPUT": self.folder
                + "/EasyBasin/Capas_SIG/Procesos_Internos/subbasin_atr3.shp",
            }
            processing.run("native:zonalstatisticsfb", params3)
            ...
            params4 = {
                ...
                "STATISTICS": [1],
                "OUTPUT": self.folder
                + "/EasyBasin/Capas_SIG/Procesos_Internos/subbasin_atr4.shp",
            }
            processing.run("native:zonalstatisticsfb", params4)
            ...
            params5 = {
                ...
                "STATISTICS": [2],
                "OUTPUT": self.folder
                + "/EasyBasin/Capas_SIG/Procesos_Internos/subbasin_atr5.shp",
            }
            processing.run("native:zonalstatisticsfb", params5)
            ...
            params6 = {
                ...
                "STATISTICS": [2],
                "OUTPUT": self.folder
                + "/EasyBasin/Capas_SIG/Procesos_Internos/subbasin_atr6.shp",
            }
            processing.run("native:zonalstatisticsfb", params6)
    ...
    def LongestFlowPath(self):
        ...
        try:
            ...
            params7 = {
                ...
                "END_POINT": outlet,
                "OUTPUT": self.folder
                + "/EasyBasin/Capas_SIG/Red_Drenaje/LongestFlowPath.shp",
            }
        ...
        # Añadir capa vectorial
        main_stream = QgsVectorLayer(
            self.folder + "/EasyBasin/Capas_SIG/Red_Drenaje/LongestFlowPath.shp",
            "Cauce Principal",
            "ogr",
        )
        crs = main_stream.crs()
        ...
        params9 = {
            ...
            "COLUMN_PREFIX": "ALT",
            "OUTPUT": self.folder
            + "/EasyBasin/Capas_SIG/Procesos_Internos/LongestFlowPath_Altitud.shp",
        }
    ...
    def RESET(self):
        ...
        reply = QMessageBox.question(
            None,
            "AVISO",
            "Recuerde que al cerrar EasyBasin, la zona de trabajo (canvas) de QGIS se limpiará y todas las capas serán borradas. Sin embargo, todos los archivos generados se mantendrán en la carpeta del proyecto. \n¿Desea continuar con el cierre?",
            QMessageBox.Yes,
            QMessageBox.No,
        )
    ...
    def Open(self):
        ...
        self.pushButton_labelPath.setStyleSheet(
